/*! layer-v2.0 弹层组件 License LGPL  /layer.layui.com/ By 贤心 */
;!function (a, b) {
    "use strict";
    var c, d, e = {
        getPath: function () {
    ...
    h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], g.pt.config = {
        ...
        switch ("string" == typeof b.area && (b.area = "auto" === b.area ? ["", ""] : [b.area, ""]), b.type) {
            case 0:
                ...
                break;
            case 2:
                var i = b.content = j ? b.content : [b.content || "/sentsin.com?from=layer", "auto"];
        ...
        if (a) {
            var b = f.getChildFrame("body", a).outerHeight(), d = c("#" + h[0] + a),
